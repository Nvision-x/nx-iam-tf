module "nx-iam" {
  ...
  enable_irsa     = true
  oidc_issuer_url = "https://oidc.eks.us-east-2.amazonaws.com/id/AB1C7FDE26C24C7F91F3BD5F538FD5A2"
  ...
  autoscaler_role_name          = "cluster-autoscaler-lab"
  autoscaler_service_account    = "cluster-autoscaler"
  lb_controller_role_name       = "aws-load-balancer-controller-lab"
